...
#define PHOTO_DEL_CYCLES							round((PACKET_SIZE/(2*N_LAMBDA))*(1/DATA_RATE)*(1/CONST_TIME))
#else
#define PHOTO_DEL_CYCLES							16//(round((PACKET_SIZE/(N_LAMBDA))*(1/DATA_RATE)*(1/CONST_TIME)))
#endif

#define PHOTONIC_DELAY								PHOTO_DEL_CYCLES//in cycles

#define HUBS_PER_CLUSTER							2//Each hub will have 4 PE associated with it
...
#define NOC_GWI_COUNT								(DEFAULT_MESH_DIM_X*DEFAULT_MESH_DIM_Y)
...
#define DEFAULT_SIMULATION_TIME                  	100000000
